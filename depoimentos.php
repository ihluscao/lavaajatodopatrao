...
<head>
    ...
    <title>Depoimentos - Lava Jato do Patrão</title>
...
<body>
    ...
    <section class="reviews">
        ...
        <p>Veja as avaliações dos nossos clientes!</p>
        <div class="review-container">
            <div class="review">
                ...
                <p>Ótimo serviço, recomendarei para amigos!</p>
            </div>
            <div class="review">
                <div class="review-header">
                    <span class="review-author">Maria Oliveira</span>
                    <span class="review-rating">★★★★★</span>
                </div>
                <p>Excelente atendimento e resultado impecável!</p>
            </div>
        </div>
    </section>
